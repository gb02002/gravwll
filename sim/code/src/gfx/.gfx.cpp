...
//   Cam->yaw += yawChange;
//   Cam->pitch =
//       fmaxf(fminf(Cam->pitch + pitchChange, DEG2RAD * 89.0f), -DEG2RAD
//       * 89.0f);
//
...
//     deltaTime); Cam->camera.position = Vector3Add(Cam->camera.position,
//     movement); Cam->camera.target = Vector3Add(Cam->camera.target, movement);
//   }
// };
//
...
//
//   // Вычисляем правый вектор: нормализованное векторное произведение forward
//   и
//   // worldUp
